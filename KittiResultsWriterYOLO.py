...
class KittiResultsWriter:
    def __init__(self, global_file=GLOBAL_OUTPUT_FILE, output_dir=OUTPUT_DIR):
        ...
        # Czyść plik globalny przy inicjalizacji
        open(self.global_file, 'w').close()

    def reset_seq_file(self, seq_name):
        """Czyści plik sekwencji na początku przetwarzania"""
...
def process_sequence(seq_name, tracker, yolo_model, writer):
    ...
    # Czyść plik sekwencji na początku przetwarzania
    writer.reset_seq_file(seq_name)
